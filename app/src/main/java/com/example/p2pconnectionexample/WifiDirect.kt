...
class WifiDirect(_context: Context ) :
    Serializable, ConnectionInfoListener, Thread() {
    companion object {
        val TAG = WifiDirect::class.java.simpleName
        ...
        const val P2P_HANDLER_MSG_STATE_DISCONNECTED = 6 // 상태 메시지 연결 해제
    }
